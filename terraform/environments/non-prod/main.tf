...
module "ec2" {
  ...
  linux_subnet_id         = module.vpc.public_subnet_ids[0]
  ...
  linux_cloud_init_file = local_file.linux_cloud_init_file.content
  # Windows Server
  windows_instance_type     = var.windows_instance_type
  windows_subnet_id         = module.vpc.public_subnet_ids[1]
